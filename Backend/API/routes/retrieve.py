...
@router.get("/data/get_summary/{user_id}")
...
@router.get("/data/get_averages/{user_id}")
def get_summary(user_id: int, session: Session = Depends(get_session)):
...
@router.get("/data/get_radar_averages/{user_id}")
...
@router.get("/data/get_sessions/{user_id}")
...
@router.get("/data/get_rower_data/{session_id}")
